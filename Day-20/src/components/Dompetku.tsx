...
import CardPengeluaran from "./CardPengeluaran";
...
interface DompetkuProps {
    PindahkeLogin: () => void
}

export default function Dompetku(props: DompetkuProps) {
  ...
  return (
    <div className="flex bg-slate-100 min-h-screen justify-center items-start py-10 font-sans">
        <button className="bg-red-500 text-white mt-6 mr-6 py-2 px-2 rounded-3xl" onClick={props.PindahkeLogin} >Logout</button>
